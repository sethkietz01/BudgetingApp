...
namespace BudgetingApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> DeleteData()
        {
            ...
            bool success = await _assetService.DeleteData(currentUser, _firestoreDb, _transactionsCollection, _goalsCollection, _assetsCollection);

            if (success)
                TempData["SuccessMessage"] = "Account reset successfully!";
            else
